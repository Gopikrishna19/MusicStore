<div class="leftpanel">
    <?php $funame = $this->foreign ? $this->foreignUN : User::name(); ?>
    <ul>
        <?php if(!$this->foreign): ?>
        <li><?php ActionLink::create("News","profile",NULL,NULL,NULL,($curr=="news"?"active":NULL)); ?></li>
        <?php endif; ?>
        <?php if($this->foreign): ?>
        <li><?php ActionLink::create("Profile","profile","of",$funame,NULL,($curr=="prof"?"active":NULL)); ?></li>
        <?php endif; ?>
        ...
        <li><?php ActionLink::create("Lists","profile","lists",$funame,NULL,($curr=="list"?"active":NULL)); ?></li>
        <?php if(!$this->foreign): ?>
        <li class="sep"></li>
